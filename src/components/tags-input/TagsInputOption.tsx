...
import type { TagsInputItem } from './tags-input-items';

// 候補の1項目。見た目は選択肢の一覧で共有する（src/internal/listbox）
// Combobox の ComboboxOption と同じ形。ラベルは素の span（Base UI の Combobox には ItemText がない）
export function TagsInputOption({ item }: { item: TagsInputItem }) {
