    ...
    appearance: {
      card: {
        item: [
          ...
          'bg-(color:--flat-bg) [--flat-bg:var(--pager-card-fill)]',
          'hover:border-(color:--pager-card-line-hover) hover:[--flat-bg:var(--pager-card-fill-hover)]',
          'active:[--flat-bg:var(--pager-card-fill-press)]',
          '[transition:--flat-bg_var(--duration-press)_var(--ease-press),border-color_var(--duration-press)_var(--ease-press),translate_var(--duration-press)_var(--ease-press),outline-color_var(--focus-ring-duration)_var(--ease-press),outline-offset_var(--focus-ring-duration)_var(--ease-press)]',
