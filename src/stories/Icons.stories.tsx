...
const entries: Entry[] = [
  ...
  },
  {
    name: 'CaretUpIcon',
    regular: <CaretUpIcon />,
    bold: <CaretUpIcon standalone />,
    use: 'NumberField の増やすボタン（縦積み）',
  },
  { name: 'MagnifyingGlassIcon', regular: <MagnifyingGlassIcon />, use: 'SearchField の虫眼鏡' },
  {
    name: 'MinusIcon',
    regular: <MinusIcon />,
    bold: <MinusIcon standalone />,
    use: 'NumberField の減らすボタン',
  },
  {
    name: 'PlusIcon',
    regular: <PlusIcon />,
    bold: <PlusIcon standalone />,
    use: 'NumberField の増やすボタン',
  },
  {
    name: 'ArrowsHorizontalIcon',
    regular: <ArrowsHorizontalIcon />,
    bold: <ArrowsHorizontalIcon standalone />,
    use: 'NumberField のラベルを左右に動かすあいだのカーソル',
  },
  {
    name: 'CaretLeftIcon',
