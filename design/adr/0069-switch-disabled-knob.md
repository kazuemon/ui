...
比較は Storybook の `Design Review/49 押せない OFF のノブ`（[`stories/axis-49-switch-disabled-knob.stories.tsx`](../stories/axis-49-switch-disabled-knob.stories.tsx)）です。地の色（押せる OFF `#E1E3E4`・押せないもの `#F2F4F4`、比 1.17）は、どの案も同じです。
