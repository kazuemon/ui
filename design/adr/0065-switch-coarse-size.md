...
比較は Storybook の `Design Review/45 指用のトグルの大きさ`（決めた時点のコミット `5de918a`。`git checkout 5de918a && pnpm storybook` で開けます）です。マウス用（40×22px・ノブ 16px）はどの案も変えません。ノブはどの案もトラックの高さから隙間 3px × 2 を引いた大きさです。
