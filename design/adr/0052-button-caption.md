...
比較は Storybook の `Design Review/31 ボタンのキャプション`（[`stories/axis-31-button-caption.stories.tsx`](../stories/axis-31-button-caption.stories.tsx)）です。1行目の現行版はキャプションなしで描いています。
