...
- **追記（principles.md から移した記録）**: 旧トークンの LightGray `#F4F5F5`・Gray `#E2E2E2` は、この ADR の中立色（`--palette-gray-50`〜`300`）に置き換えました。LightGreen（`--palette-mint-50`）は値の層にだけあり、役割はまだ当てていません
