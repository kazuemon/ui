...
比較は Storybook の `Design Review/43 すべて選ぶのグループの枠`（[`stories/axis-43-choice-group-frame.stories.tsx`](../stories/axis-43-choice-group-frame.stories.tsx)）です。枠を付ける案はどれも同じ見た目（線は細い境界線の色、角はカードの角、影なし）です。
