...
実機（Android の Chrome）で分かったことは、次のとおりです。iPad でも同じ作りで動きました。
...
iPad でも、ユーザーが確かめました。キーボードが出ること、スクロール位置がずれないこと、下端に帯が残らないこと、閉じたあとの位置に問題はありませんでした。
...
- トークンの追加はありません
- backlog に、縮み 120px の閾値が画面の高さの小さい端末で足りるか、を足します
